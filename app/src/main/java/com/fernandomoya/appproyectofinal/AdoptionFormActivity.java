...
public class AdoptionFormActivity extends AppCompatActivity {
    ...
    EditText nombresApellidos;
    EditText cedula;
    EditText edad;
    EditText telefono;
    EditText email;
    EditText direccion;
    EditText nombresApellidosReferencia;
    EditText parentesco;
    EditText telefonoReferencia;
    EditText instruccion;
    EditText visita;
    EditText m2;
    EditText ocupacion;
    EditText otros;
    ...
    EditText pregunta3;
    EditText pregunta4;
    TextView edadAdopcion;
    TextView tamanoAdopcion;
    TextView tipoAdopcion;
    TextView sexoAdopcion;
    RadioButton rdbPrimaria;
    RadioButton rdbSecundario;
    RadioButton rdbUniversidad;
    RadioButton rdbPostgrado;
    RadioButton rdbCasa;
    RadioButton rdbDepartamento;
    RadioButton rdbPropio;
    RadioButton rdbOtros;
    RadioButton rdbArrendado;
    RadioButton rdbCinco;
    RadioButton rdbVeinte;
    RadioButton rdbCincuenta;
    RadioButton rdbMas;
    RadioButton rdbVeterinario;
    RadioButton rdbMedica;
    RadioButton rdbSane;
    RadioButton rdbSi;
    RadioButton rdbNo;
    Button btnGuardar;
